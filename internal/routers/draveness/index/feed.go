...
func New(map[string]string) (*fetch.Source, error) {
	link := "https://draveness.me/index"
	return &fetch.Source{
		Title:       "面向信仰编程 - 首页",
		Description: "面向信仰编程 - 首页",
		Link:        link,
		...
		Parse: func(obj interface{}) ([]*fetch.Item, error) {
			...
			doc.Find(".archive-item").Each(func(i int, sel *goquery.Selection) {
